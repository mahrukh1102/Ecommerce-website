...
const Topnav = () => {
  ...
  return (
    <div className="flex flex-col justify-center bg-white h-[69px] sm:h-[132px] w-full max-w-[1440px] mx-auto">
      {/* Top Section */}
      ...
      {/* Navigation Links */}
      <div className="hidden sm:flex flex-wrap justify-center gap-[44px] mt-4">
